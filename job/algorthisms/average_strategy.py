...
class AverageStrategy:
    def __init__(self, pool, pool_data, pool_hour_data, pool_day_data, protocol='ethereum'):
        self.pool_data = pool_data
        self.pool_day_data = pool_day_data
        self.pool = pool
        self.protocol = protocol
        self.pool_hour_data = pool_hour_data
    ...
    def find_range(self, current_price):
        ...
        for d in self.pool_day_data:
            ...
            if price > current_price:
                ...
                above_volumes += volume + above_volumes
            else:
